    ...
    class FormSteps {
        ...
        updateForm() {
            ...
            if (this.currentStep === 5) {
                ...
                var bagsQuantity = document.getElementById("quantity").value;
                ...
                var institution = document.querySelector('input[type="radio"]:checked').id;
                var i = 1;
                ...
                addressUl.appendChild(newLi()).innerHTML = zip;
